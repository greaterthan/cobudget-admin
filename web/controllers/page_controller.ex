defmodule Dbtest.PageController do
  use Dbtest.Web, :controller

  alias Dbtest.Group
  alias Dbtest.Bucket
  alias Dbtest.Allocation
  alias Dbtest.User
  alias Dbtest.Membership
  alias Dbtest.Contribution
  alias Dbtest.Comment
